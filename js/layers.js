...
addLayer("a", {
    ...
    branches: ["z"],
    color: "#C7002A",
    requires() { return new Decimal(10).times((player.a.unlockOrder.neq(new Decimal(0)) && !player.a.unlocked)?100:1) }, // Can be a function that takes requirement increases into account
    ...
    upgrades: {
        ...
        21: {
            ...
            description: "Abominations boost their own effect.",
            cost() { return tmp.f.upCostMult.times(15) },
            unlocked() { return hasUpgrade("f", 14) },
            effect() {
                eff = player.a.points.pow(2)
                return eff
            },
...
addLayer("f", {
    ...
    branches: ["z"],
    color: "#878787",
    requires() { return new Decimal(200).times((player.f.unlockOrder.neq(new Decimal(0)) && !player.f.unlocked)?5000:1) }, // Can be a function that takes requirement increases into account
    ...
    effBase() {
        base = new Decimal(2)
        // if(hasUpgrade("f", 21)) base = base.plus(1)
    ...
    upgrades: {
        ...
        21: {
            ...
            description: "Add 1 to the death factory effect base.",
            cost() { return tmp.f.upCostMult.times(15) },
            unlocked() { return hasUpgrade("f", 14) },
        },
        22: {
            title: "Fabricator Fabricators",
            description: "Armaments boost armament gain.",
            cost() { return tmp.f.upCostMult.times(30) },
            unlocked() { return hasUpgrade("f", 21) },
            effect() {
                let eff = player.f.power.pow(0.25)
                return eff
            },
    ...
    milestones: {
        ...
        1: {
            ...
            effectDescription() { return "Armaments also affect abominations with reduced effect<br>Currently: " + format(tmp.f.powerEff.pow(0.5)) + "x" },
        },
        2: {
